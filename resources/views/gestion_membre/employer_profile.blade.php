                        ...
                        <div class="card-title mb-4">
                            <div class="d-flex justify-content-start">
                                ...
                                <div class="userData ml-3">
                                    <h2 class="d-block" style="font-size: 1.5rem; font-weight: bold">Some Name</h2>
                            ...
                            <div class="col-12">
                                ...
                                <div class="tab-content ml-1" id="myTabContent">
                                    <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labelledby="basicInfo-tab">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label style="font-weight:bold;">éQUIPE_Id</label>
                                            </div>
                                            <div class="col-md-8 col-6">
                                                Something
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label style="font-weight:bold;">Salaire</label>
                                            </div>
                                            <div class="col-md-8 col-6">
                                                Something
                                            </div>
                                        ...
                                        <hr />
                                        <a href="employer_profile?maj=1"> <button  class="profile-edit-btn btn-warning" name="maj" >update</btton></a>
                                    </div>
